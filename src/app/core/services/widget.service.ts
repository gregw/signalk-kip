...
export class WidgetService {
  ...
  private readonly _componentTypeMap: Record<string, () => Promise<Type<unknown>>> = {
    ...
    WidgetRacerStartLineComponent: () => import('../../widgets/widget-racer-start-line/widget-racer-start-line.component').then(m => m.WidgetRacerStartLineComponent),
...
/*     {
    ...
    },
    {
      ...
      componentClassName: 'WidgetRacerStartLineComponent',
    },
    {
